...
- **Mode selection**: Set `DRONE_MODE_SELECT` to `DRONE_MODE_USE_SWITCH`, `DRONE_MODE_FORCE_DEBUG`, or `DRONE_MODE_FORCE_NORMAL`.
- **Forced flight mode**: IMU calibration then automatic unlock remain active; forced debug mode keeps motors disabled.
